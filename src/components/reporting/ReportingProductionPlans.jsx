...
const ReportingProductionPlans = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(
          'https://ui.boondmanager.com/api/reporting-production-plans',
          {
            method: 'GET',
            headers: {
  ...
  return (
    <div>
      <h2>Production Plans Reporting</h2>
      {/* Render your data here */}
    </div>
  );
};

export default ReportingProductionPlans;
